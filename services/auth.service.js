...
export const requestVerificationOtpService = async (
  email
) => {
  const normalizedEmail = normalizeEmail(email);
...
export const verifyTeacherOtpService = async (
  email,
  otp
) => {
  ...
  // Keep account pending until password setup is completed.
...
export const completeFirstLoginService = async (
  ...
  try {
    ...
    // Password operation must not fail because
...
export const changePasswordService = async (
  ...
  try {
    ...
    // Do not fail the password change because
    // notification email failed.
  }
...
export const updateProfileService = async (
  ...
  if (data.profile !== undefined) {
    ...
    // Date of birth
    if (data.profile.dob !== undefined) {
      if (data.profile.dob === null) {
